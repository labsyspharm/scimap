...
def foldchange (adata, from_group, to_group=None, imageid='imageid', phenotype='phenotype',
    ...
    imageid : string, optional
        The column that contains the samples/ROI information. The default is 'imageid'.
    phenotype : string, optional
        The column that contains the cell-type/phenotype information. The default is 'phenotype'.
    normalize : bool, optional
        ...
        cell types passed in via `subset_phenotype`. The default is True.
